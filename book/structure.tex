...
%--------------------------------------
\usepackage{hyphenat}
\hyphenation{mate-mática conhe-cido}
%--------------------------------------
...
\titlecontents{lsubsection}
	...
	{\normalfont\footnotesize\sffamily} % Spacing and font options for subsections
	{}
	{}
	{}
...
\markboth{}{}%
{%
\begin{tcolorbox}[enhanced,breakable,halign=right,left skip=5cm,nobeforeafter,frame hidden,
  remember,
  height fixed for=all,
  overlay={%
    \fill[ocre!20] (current page.north west) rectangle (\paperwidth,-\paperheight);
    \node at ($(current page.north east)+(-6cm,-2cm)$){{\color{white}\fontsize{30}{30}\sffamily\bfseries#2}};
...
\draw[anchor=west] (\Gm@lmargin+.3cm,-4.05cm) node [text width=15cm] {\huge\sffamily\bfseries\color{black}\thechapter\autodot~#1\strut};
\end{tikzpicture}};
\end{tikzpicture}
\else
\begin{tikzpicture}[remember picture,overlay]
