...
\tightlist
\item
  \href{https://www.vam.ac.uk/moc/collections/mr-potato-head/}{V\&A
  Museum of Childhood}
\item
  \href{https://www.imdb.com/title/tt0114709/}{Toy Story (IMDB)}
\end{itemize}
...
\begin{figure}
  ...
  \begin{tikzpicture}
    \node [inner sep=0pt] at (0,0) {
      \includegraphics[width=0.8\textwidth,keepaspectratio]{./S01/img/1/tres-destinos.png}
    };
    \draw [white, rounded corners=\ClipSep, line width=\ClipSep]
    (current bounding box.north west) --
    (current bounding box.north east) --
...
\tightlist
\item
  \href{https://www.ecured.cu/Tres_destinos_(Telenovela)}{EcuRed}
\item
  \href{https://www.imdb.com/title/tt0211876/}{IMDB}
\item
  \href{https://www.youtube.com/watch?v=kfIk131FZxU}{Abertura (YouTube)}
\end{itemize}
...
\begin{figure}
  ...
  \begin{tikzpicture}
    \node [inner sep=0pt] at (0,0) {
      \includegraphics[width=0.8\textwidth,keepaspectratio]{./S01/img/1/my-favorite-things.png}
    };
    \draw [white, rounded corners=\ClipSep, line width=\ClipSep]
    (current bounding box.north west) --
    (current bounding box.north east) --
...
\textless template \#original\textgreater{} When I'm feeling sad I
simply remember my favorite things \textless template
\#traducao\textgreater{} Quando me sinto triste Simplesmente lembro de
...
\textless template \#original\textgreater{} Raindrops on roses And
whiskers on kittens Doorbells and sleigh bells And something with
mittens La la la la something with strings \textless template
\#traducao\textgreater{} Pingos de chuva em rosas E bigodes de gatinhos
Campainhas e sinos E algo com luvas de lã La la la la algo com cordas

Versão original:

\textless template \#original\textgreater{} Raindrops on roses And
whiskers on kittens Bright copper kettles And warm woolen mittens Brown
paper packages Tied up with strings \textless template
\#traducao\textgreater{} Pingos de chuva em rosas E bigodes de gatinhos
Brilhantes tachos de cobre E quentes luvas de lã Pacotes de papel pardo
Amarrado com cordas
...
\tightlist
\item
  \href{https://www.youtube.com/watch?v=DGABqdbtQnA}{Trecho do filme The
  Sound of Music, em que é possível ouvir My Favorite Things (Youtube)}
\item
  \href{https://en.wikipedia.org/wiki/My_Favorite_Things_(song)}{Wikipédia}
\item
  \href{https://www.imdb.com/title/tt0059742/}{A Noviça Rebelde (IMDB)}
\item
  \href{https://www.vagalume.com.br/julie-andrews/my-favorite-things-traducao.html}{Letra
  e tradução - Vagalume}
\end{itemize}
...
\begin{figure}
  ...
  \begin{tikzpicture}
    \node [inner sep=0pt] at (0,0) {
      \includegraphics[width=0.8\textwidth,keepaspectratio]{./S01/img/1/maina-la-voyante.png}
    };
    \draw [white, rounded corners=\ClipSep, line width=\ClipSep]
    (current bounding box.north west) --
    (current bounding box.north east) --
...
Quando Chandler vai atender o interfone, o poster \emph{Maina La
...
\tightlist
\item
  \href{https://postermuseum.com/products/maina-la-voyante}{PosterMuseum}
\end{itemize}
...
\begin{figure}
  ...
  \begin{tikzpicture}
    \node [inner sep=0pt] at (0,0) {
      \includegraphics[width=0.8\textwidth,keepaspectratio]{./S01/img/1/speed-racer.png}
    };
    \draw [white, rounded corners=\ClipSep, line width=\ClipSep]
    (current bounding box.north west) --
    (current bounding box.north east) --
...
\tightlist
\item
  \href{https://www.imdb.com/title/tt0061300/}{IMDB}
\item
  \href{https://www.omelete.com.br/series-tv/lembra-desse-speed-racer-a-serie-original}{Review
  do Omelete}
\item
  \href{https://www.youtube.com/watch?v=suCm1w_KTiY}{Abertura (YouTube)}
\end{itemize}
...
\begin{figure}
  ...
  \begin{tikzpicture}
    \node [inner sep=0pt] at (0,0) {
      \includegraphics[width=0.8\textwidth,keepaspectratio]{./S01/img/1/joanie-loves-chachi.png}
    };
    \draw [white, rounded corners=\ClipSep, line width=\ClipSep]
    (current bounding box.north west) --
    (current bounding box.north east) --
...
\tightlist
\item
  \href{https://www.imdb.com/title/tt0083433/}{IMDB}
\item
  \href{https://en.wikipedia.org/wiki/Joanie_Loves_Chachi}{Wikipédia}
\end{itemize}
...
\begin{figure}
  ...
  \begin{tikzpicture}
    \node [inner sep=0pt] at (0,0) {
      \includegraphics[width=0.8\textwidth,keepaspectratio]{./S01/img/1/billy-dont-be-a-hero.png}
    };
    \draw [white, rounded corners=\ClipSep, line width=\ClipSep]
    (current bounding box.north west) --
    (current bounding box.north east) --
...
\tightlist
\item
  \href{http://www.bodonaldson.net/}{Site Oficial}
\item
  \href{https://en.wikipedia.org/wiki/Billy_Don\%27t_Be_a_Hero}{IMDB}
\item
  \href{https://www.metrolyrics.com/billy-dont-be-a-hero-lyrics-paper-lace.html}{Letra
  - MetroLyrics}
\item
  \href{https://www.youtube.com/watch?v=1qlK9TJvuSk}{Billy, don't be a
  hero - YouTube}
\end{itemize}

\hypertarget{pinuxf3quio}{%
\section{Pinóquio}\label{pinuxf3quio}}

\begin{figure}
  \centering
  \begin{tikzpicture}
    \node [inner sep=0pt] at (0,0) {
      \includegraphics[width=0.8\textwidth,keepaspectratio]{./S01/img/1/pinocchio.png}
    };
    \draw [white, rounded corners=\ClipSep, line width=\ClipSep]
    (current bounding box.north west) --
    (current bounding box.north east) --
    ...
    ;
    \end{tikzpicture}
    \caption{Pinóquio\label{fig:pin-quio}}
\end{figure}
...
Referência ao filme
\href{https://www.imdb.com/title/tt0032910/}{Pinóquio} (1940), produzido
pela Walt Disney, onde é contada a história de um velho carpinteiro
chamado Gepetto, que faz um boneco de madeira chamado Pinóquio, o qual é
trazido a vida pela Fada Azul, com a condição de que ele demonstre
obediência, bravura e lealdade a seu criador.
...
\tightlist
\item
  \href{https://www.imdb.com/title/tt0032910/}{IMDB}
\item
  \href{https://pt.wikipedia.org/wiki/Pin\%C3\%B3quio_(filme)}{Wikipédia}
\end{itemize}
...
\begin{figure}
  ...
  \begin{tikzpicture}
    \node [inner sep=0pt] at (0,0) {
      \includegraphics[width=0.8\textwidth,keepaspectratio]{./S01/img/1/liza-minnelli.png}
    };
    \draw [white, rounded corners=\ClipSep, line width=\ClipSep]
    (current bounding box.north west) --
    (current bounding box.north east) --
...
\tightlist
\item
  \href{https://www.imdb.com/name/nm0591485/}{IDMB}
\item
  \href{https://pt.wikipedia.org/wiki/Liza_Minnelli}{Wikipédia}
\end{itemize}
