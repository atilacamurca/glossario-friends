...
conhecido como `Penis Envy' (Inveja do pênis).\footnote{\sloppy Freud and penis envy - The British Psychological Society (Inglês). \url{https://bit.ly/3gmo8cY}}
...
\begin{figure}[!ht]
  \begin{adjustwidth}{-\oddsidemargin-1in}{-\rightmargin}
    \centering
    \includegraphics[trim={0 9cm 0 2cm,}, clip, width=\paperwidth]{./S01/img/6/richard-leakey.png}
...
\begin{figure}
  ...
  \begin{tikzpicture}
    \node [inner sep=0pt] at (0,0) {
      \includegraphics[width=0.5\textwidth,keepaspectratio]{./S01/img/6/richard-leakey-with-fossil.jpg}
    };
...
\begin{figure}[!ht]
  \begin{adjustwidth}{-\oddsidemargin-1in}{-\rightmargin}
    \centering
    \includegraphics[trim={0 8cm 0 2cm,}, clip, width=\paperwidth]{./S01/img/6/raggedy-ann.png}
...
\begin{figure}[!ht]
  \begin{adjustwidth}{-\oddsidemargin-1in}{-\rightmargin}
    \centering
    \includegraphics[trim={0 6cm 0 4cm,}, clip, width=\paperwidth]{./S01/img/6/al-pacino.png}
