  ...
  <div class="content-wrapper bg-background-primary font-sans text-primary leading-normal flex flex-col min-h-screen" :class="theme">
    <header class="border-t-14 border-blue-600">
      <nav class="container mx-auto flex flex-wrap justify-between items-center py-8">
        <div>
          <g-link v-if="theme === 'theme-light'" to="/"><g-image src="../../static/Friends_logo.svg" class="w-40" alt="logo" width="160" /></g-link>
          <g-link v-else to="/"><g-image src="../../static/Friends_logo_dark.svg" class="w-40" alt="logo" width="160" /></g-link>
        </div>
    ...
    <footer class="bg-blue-700 text-white">
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
        ...
        <ul class="flex items-center space-x-8">
          ...
          <li>
            <a href="https://github.com/atilacamurca/glossario-friends"
              target="_blank"
              rel="noopener"
              class="text-white hover:text-gray-400"
              aria-label="Acesse o repositório do Github">
          ...
          <li>
            <a href="https://twitter.com/atilacamurca"
              target="_blank"
              rel="noopener"
              class="text-white hover:text-gray-400"
              aria-label="Acesse o Twitter de @atilacamurca">
